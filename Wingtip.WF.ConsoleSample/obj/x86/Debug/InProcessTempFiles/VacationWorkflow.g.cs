...
namespace DevLeap.WF4.SampleFlow {
    
    
    [System.Runtime.InteropServices.ComVisible(false)]
    public partial class VacationWorkflow : System.Activities.Activity, System.ComponentModel.ISupportInitialize {
...
partial void AfterInitializeComponent();
        ...
        public void InitializeComponent() {
            ...
            System.IO.Stream initializeXaml = typeof(VacationWorkflow).Assembly.GetManifestResourceStream(resourceName);
            ...
            try {
                ...
                writerSettings.AccessLevel = System.Xaml.Permissions.XamlAccessLevel.PrivateAccessTo(typeof(VacationWorkflow));
        ...
        private string FindResource() {
            string[] resources = typeof(VacationWorkflow).Assembly.GetManifestResourceNames();
            for (int i = 0; (i < resources.Length); i = (i + 1)) {
                string resource = resources[i];
                if ((resource.Contains(".VacationWorkflow.g.xaml") || resource.Equals("VacationWorkflow.g.xaml"))) {
                    return resource;
                }
            }
